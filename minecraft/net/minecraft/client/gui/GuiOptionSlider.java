    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            if (this.dragging) {
                ...
                int mx = Math.min(Math.max(this.xPosition + 4,mouseX),this.xPosition + this.width - 4);
                RenderUtils.drawRoundRect(mx - 4, this.yPosition,mx + 4,this.yPosition + 20,4,new Color(0,0,0,100));
            } else {
                RenderUtils.drawRoundRect(this.xPosition + (int)(this.sliderValue * (float)(this.width - 8)), this.yPosition,this.xPosition + (int)(this.sliderValue * (float)(this.width - 8)) + 8,this.yPosition + 20,4,new Color(0,0,0,100));
            }
        }
    }
