    ...
    class Button extends GuiButton {
        ...
        protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                ...
                RenderUtils.drawRoundRect(this.xPosition + (int) (this.field_146156_o * (float) (this.width - 8)), this.yPosition, this.xPosition + (int) (this.field_146156_o * (float) (this.width - 8)) + 8, this.yPosition + 20, 4, new Color(0, 0, 0, 100));
