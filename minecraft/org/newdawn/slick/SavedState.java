...
public class SavedState {
	 ...
	 * 
	 * @param nameOfField  The name of the number to retrieve
	 * @param defaultValue The value to return if the specified value hasn't been
	 *                     set
	 * @return The number saved at this location
	 */
	...
	/**
	 * Save the given value at the given location will overwrite any previous value
	 * at this location
	 * 
	...
	public void setNumber(String nameOfField, double value) {
		numericData.put(nameOfField, value);
	}
	...
	private boolean isWebstartAvailable() {
		try {
			Class.forName("librarys.javax.jnlp.ServiceManager");
