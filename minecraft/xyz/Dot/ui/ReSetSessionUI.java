...
public class ReSetSessionUI extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.textFieldList.add(new GuiTextField(1, fontRendererObj, RenderUtils.width() / 2 - 100, RenderUtils.height() / 5 + 32, 200, 20));
        this.textFieldList.add(new GuiTextField(2, fontRendererObj, RenderUtils.width() / 2 - 100, RenderUtils.height() / 5 + 64, 200, 20));
        this.textFieldList.add(new GuiTextField(3, fontRendererObj, RenderUtils.width() / 2 - 100, RenderUtils.height() / 5 + 96, 200, 20));
        this.textFieldList.add(new GuiTextField(4, fontRendererObj, RenderUtils.width() / 2 - 100, RenderUtils.height() / 5 + 128, 200, 20));
        ...
        this.buttonList.add(new GuiButton(0, RenderUtils.width() / 2 - 100, RenderUtils.height() / 5 + 160, "OK"));
        this.buttonList.add(new GuiButton(1, RenderUtils.width() / 2 - 100, RenderUtils.height() / 5 + 184, "Cancel"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        fontRendererObj.drawString("Username", this.width / 2 - 100, RenderUtils.height() / 5 - 10, new Color(128, 128, 128).getRGB());
        fontRendererObj.drawString("PlayerID", this.width / 2 - 100, RenderUtils.height() / 5 + 32 - 10, new Color(128, 128, 128).getRGB());
        fontRendererObj.drawString("Token", this.width / 2 - 100, RenderUtils.height() / 5 + 64 - 10, new Color(128, 128, 128).getRGB());
        fontRendererObj.drawString("SessionType (legacy/mojang)", this.width / 2 - 100, RenderUtils.height() / 5 + 96 - 10, new Color(128, 128, 128).getRGB());
        fontRendererObj.drawString("Code", this.width / 2 - 100, RenderUtils.height() / 5 + 128 - 10, new Color(128, 128, 128).getRGB());
