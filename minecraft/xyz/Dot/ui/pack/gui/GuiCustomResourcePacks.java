...
import xyz.Dot.ui.pack.packs.ResourcePackListEntryFolder;
import xyz.Dot.ui.pack.packs.ResourcePackListProcessor;
import xyz.Dot.ui.pack.repository.ResourcePackRepositoryCustom;
...
public class GuiCustomResourcePacks extends GuiScreenResourcePacks{
	...
	public void initGui(){
		...
		buttonList.add(new GuiOptionButton(20,width/2-74,height-26,70,20, Translator.getInstance().m("Refresh")));
