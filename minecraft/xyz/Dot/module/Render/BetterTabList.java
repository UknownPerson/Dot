...
public class BetterTabList extends Module {
    public static Setting header = new Setting(ModuleManager.getModuleByName("BetterTabList"), "Header", false);
    public static Setting footer = new Setting(ModuleManager.getModuleByName("BetterTabList"), "Footer", false);
