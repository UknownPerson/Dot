...
public class Sprint extends Module {
    ...
    private void onUpdate(EventPreUpdate event) {
        ...
        if (mc.thePlayer.getFoodStats().getFoodLevel() > 6 && !mc.thePlayer.isBlocking() && !mc.thePlayer.isSneaking() && (omni.isToggle() ? mc.thePlayer.moving() : this.mc.thePlayer.moveForward > 0.0f)) {
