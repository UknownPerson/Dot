...
public class Coordinate extends Component {
    ...
    public void drawHUD(float x, float y, float partialTicks) {
        ...
        FontLoaders.normalfont16.drawString("Coordinate", (int) x + 5, (int) y + 4, new Color(255, 255, 255).getRGB());
        y = y + 12;
        ...
        this.setWidth(mc.fontRendererObj.getStringWidth("Biome: " + Biome + "SEEEEE"));
        ...
        mc.fontRendererObj.drawStringWithShadow("Biome: ", x + 5, y + 4 + mc.fontRendererObj.FONT_HEIGHT + 2 + mc.fontRendererObj.FONT_HEIGHT + 2 + mc.fontRendererObj.FONT_HEIGHT + 2, -1);
        mc.fontRendererObj.drawStringWithShadow(Biome, x + 5 + mc.fontRendererObj.getStringWidth("Biome: "), y + 4 + mc.fontRendererObj.FONT_HEIGHT + 2 + mc.fontRendererObj.FONT_HEIGHT + 2 + mc.fontRendererObj.FONT_HEIGHT + 2, mc.theWorld.getBiomeGenForCoords((BlockPos)mc.thePlayer.getPosition()).color);
    }
